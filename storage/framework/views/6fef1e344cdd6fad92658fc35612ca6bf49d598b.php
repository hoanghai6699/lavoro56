...
<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/admin/bower_components/ckeditor/ckeditor.js"></script>
        <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/admin/bower_components/ckfinder/ckfinder.js"></script>
        <script type="text/javascript">
            var baseURL = "<?php echo url('/'); ?>";
        </script>
        <script type="text/javascript" src="<?php echo e(url('/')); ?>/public/admin/bower_components/func_ckfinder.js"></script>
        <!--[if lt IE 9]>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo e(route('frontend.get.home')); ?>" class="logo">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown notifications-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="header">Bạn có <?php if(count($user->unreadNotifications) > 0): ?> <?php echo e(count($user->unreadNotifications)); ?><?php else: ?> 0 <?php endif; ?> thông báo mới</li>
                                    <li style="width: 294px;">
                                        <ul class="menu">
                                            <?php $__currentLoopData = $user->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <li><a href="<?php echo e(route('admin.get.view.order',$data_order_Detail['id'])); ?>" style="<?php echo e($hightLigth); ?>">Đơn đặt hàng mới nhất: <?php echo e($after_format); ?></a></li>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <span class="hidden-xs">Xin chào <?php echo Auth::user()->name; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="<?php echo route('logout'); ?>" class="btn btn-default btn-flat">Đăng xuất</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo e(url('/')); ?>/public/admin/img/8.jpg" class="img-circle" alt="User Image">
                        </div>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="<?php echo e(\Request::route()->getName()=='admin'?'active':''); ?>">
                        ...
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.category' || \Request::route()->getName()=='admin.get.add.category' ? 'active' : ''); ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.category'?'active':''); ?>"><a href="<?php echo route('admin.get.list.category'); ?>"><i class="fa fa-circle-o"></i> Quản lý danh mục</a></li>
                        ...
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.product' || \Request::route()->getName()=='admin.get.add.product' || \Request::route()->getName()=='importExportView' ? 'active' : ''); ?> treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.product'?'active':''); ?>"><a href="<?php echo route('admin.get.list.product'); ?>"><i class="fa fa-circle-o"></i> Quản lý sản phẩm</a></li>
                                ...
                                <li class="<?php echo e(\Request::route()->getName()=='importExportView'?'active':''); ?>"><a href="<?php echo route('importExportView'); ?>"><i class="fa fa-circle-o"></i> Import/Export</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.article' || \Request::route()->getName()=='admin.get.add.article' ? 'active' : ''); ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.article'?'active':''); ?>"><a href="<?php echo route('admin.get.list.article'); ?>"><i class="fa fa-circle-o"></i> Quản lý bài viết</a></li>
                        ...
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.user' || \Request::route()->getName()=='admin.get.add.user' ? 'active' : ''); ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.user'?'active':''); ?>"><a href="<?php echo route('admin.get.list.user'); ?>"><i class="fa fa-circle-o"></i> Quản lý thành viên</a></li>
                        ...
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.sale' || \Request::route()->getName()=='admin.get.add.sale' ? 'active' : ''); ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.sale'?'active':''); ?>"><a href="<?php echo route('admin.get.list.sale'); ?>"><i class="fa fa-circle-o"></i> Danh sách khuyến mãi</a></li>
                        ...
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.coupon' || \Request::route()->getName()=='admin.get.add.coupon' ? 'active' : ''); ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.coupon'?'active':''); ?>"><a href="<?php echo route('admin.get.list.coupon'); ?>"><i class="fa fa-circle-o"></i> Danh sách mã giảm giá</a></li>
                        ...
                        <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.slide' || \Request::route()->getName()=='admin.get.add.slide' ? 'active' : ''); ?> treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.list.slide'?'active':''); ?>"><a href="<?php echo route('admin.get.list.slide'); ?>"><i class="fa fa-circle-o"></i> Danh sách slide</a></li>
                                <li class="<?php echo e(\Request::route()->getName()=='admin.get.add.slide'?'active':''); ?>"><a href="<?php echo route('admin.get.add.slide'); ?>"><i class="fa fa-circle-o"></i> Thêm mới</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
        ...
        <!-- jQuery UI 1.11.4 -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
        ...
        <!-- Morris.js charts -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/raphael/raphael.min.js"></script>
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/morris.js/morris.min.js"></script>
        <!-- Sparkline -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
        <!-- jvectormap -->
        <script src="<?php echo e(url('/')); ?>/public/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="<?php echo e(url('/')); ?>/public/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
        <!-- jQuery Knob Chart -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
        <!-- daterangepicker -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/moment/min/moment.min.js"></script>
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
        <!-- datepicker -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php echo e(url('/')); ?>/public/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
        <!-- Slimscroll -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
        <!-- FastClick -->
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/fastclick/lib/fastclick.js"></script>
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="<?php echo e(url('/')); ?>/public/admin/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
        <!-- AdminLTE App -->

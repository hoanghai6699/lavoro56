				...
				<div class="topbar-left">
					...
					<aside class="sidebar-content">
						<form id="size" method="get">
							...
							<select name="size" class="size" style="width: 150px;">
								<option <?php echo e(Request::get('size') == "" || !Request::get('size') ? "selected='selected'" : ""); ?> value=""><?php echo trans('message.default'); ?></option>
					...
					<aside class="sidebar-content">
						...
						<ul>
							...
							<?php $__currentLoopData = $c1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_c1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($item_c1->active == 1): ?>
							<li><a href="<?php echo e(route('frontend.get.loaisanpham',[$item_c1->id,$item_c1->slug])); ?>"><?php echo e($item_c1->name); ?></a><span> </span></li>
							<?php endif; ?>
							...
							<div class="col-md-12 col-sm-4 col-xs-12 text-center">
								<div class="pages">
									...
									<ul>
										...
										<li><a href="<?php echo str_replace('/?','?',$product->url($product->currentPage() - 1 )); ?>"><i class="fa fa-arrow-left"></i></a></li>
										<?php endif; ?>
										<?php for($i = 1; $i <= $product->lastPage() ; $i++): ?>
										<li class="<?php echo ($product->currentPage() == $i) ? 'active' : ''; ?>">
										<a href="<?php echo str_replace('/?','?',$product->url($i)); ?>"><?php echo $i; ?></a>
										</li>
										<?php endfor; ?>
										<?php if( $product->currentPage() != $product->lastPage() ): ?>
										<li><a href="<?php echo str_replace('/?','?',$product->url($product->currentPage() + 1 )); ?>"><i class="fa fa-arrow-right"></i></a></li>
										<?php endif; ?>
